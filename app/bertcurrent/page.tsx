  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between lg:gap-16 md:gap-8 lg:p-24 md:p-12">
        ...
        <iframe 
            width="1200" 
            height="100%" 
            src="https://www.figma.com/embed?embed_host=share&url=https%3A%2F%2Fwww.figma.com%2Fproto%2Fov5YtfX0qu8qT5A4Wmkrw5%2FIDP_AdminDashRefresh_Q1_2024%3Fpage-id%3D1202%253A488356%26type%3Ddesign%26node-id%3D1202-489962%26viewport%3D730%252C54%252C0.57%26t%3DV1SANvqLYOOjEscJ-1%26scaling%3Dscale-down-width%26starting-point-node-id%3D1202%253A489962%26mode%3Ddesign" 
        />
        </Box>
        ...
        <form action={formUrl} method="post" className="flex flex-col" >
